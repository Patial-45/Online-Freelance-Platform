...
const Authenticate = require('./middleware/authenticate'); // ✅ added
...
app.get('/JobsFetch', async (req, res) => {
    ...
    res.json({ data: JobsFetch });
});

app.post('/Freelancers', Authenticate, (req, res) => {
...
app.get('/FreelancersFetch', async (req, res) => {
    ...
    res.json({ data: FreelancersFetch });
});
